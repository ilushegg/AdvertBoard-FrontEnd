This application works with its own AdvertBoard API.
...
## You can add advertisements to your Favorite list. If you are not registered, the ads will be stored in localstorage and will be added to the database during registration.
