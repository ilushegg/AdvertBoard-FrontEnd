...
import { FavoriteAdvertisement } from 'src/app/models/favorite-ad.model';
...
export class ProfileFavoritesComponent implements OnInit {
  ...
  public ads: GetPagedResult<FavoriteAdvertisement>;
  public pageSize = 5;
  public pageNumber = 1;
  isVisible = false;
  public adsTotal = this.pageSize;

  constructor(private favoriteService: FavoriteService, public loadingService: LoadingService, private authService: AuthService, private nzMessageService: NzMessageService) { }

  ngOnInit(): void {
    this.loadingService.isLoading$.next(true);
    this.favoriteService.getFavoriteAdsPagedFiltered(0, this.pageSize, this.user.id).subscribe(res => {
      this.ads = res;
      this.ads.items.forEach(el => {
        el.deleted = false;
      })
